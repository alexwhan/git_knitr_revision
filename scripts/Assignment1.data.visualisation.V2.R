#Ag & F Data School, March 2018
#Visualization Practical ::: Madeleine Barton
#Curd Firmness of Milk 
#====================================================================================================
...
#This experiment investigates the rennet gel 'curd firmness' after 1 hour for milks with different 
#properties according to this design:
...
df<-read_csv("~/r.repro.analysis/data/VisMilk.csv")
...
#b. the dependent variable (trait being tested) is milk curdness, so "gather" the columns from wide to long,
#and generate a new column called "curd.firm"
...
ggplot(df.tidy, aes(x = fats, y=curd.firm)) +
  geom_point()  + 
  facet_wrap(~Experiment)
#here, looks like there's no strong relationship with fats and curd-firm 
#two outliers here specific to a particualar experiment..?
